...
ウィキデータに石造物の情報を入力する際に使用するプロパティについて説明します。
...
| P1684(銘) | 銘文 | |修飾子P518(あてはまる部分)で刻まれた位置を示す<br/>修飾子P3831(オブジェクトの役割)で役割を示す |

### 刻像に関する情報
| プロパティ(ラベル) | 説明 | 値の例 | 備考 |
| --- | --- | --- | --- |
| P180(題材) | 彫られている像 |Q11662826(青面金剛)<br/>Q11446712(如意輪観音)<br/>Q604687(地蔵菩薩)<br/>など | |
| P2079(制作技法) |  | Q14562306(浅浮き彫り)<br/>Q2520013(丸彫り)など | 刻像塔で使用 |
